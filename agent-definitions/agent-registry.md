...
| Archibald       | Project Architecture & Task Delegation | User task descriptions, existing architecture decisions, agent definitions, docs/wi-<NNNN>-contract-ready.md (from Gerard), docs/femke-structural-change-signal.md (from Femke), docs/alignment-review-request.md (Alignment Agent approval decisions, consumed autonomously) | `docs/wi-<NNNN>-delegation-gerard.md` (Gerard delegation plan), `docs/wi-<NNNN>-delegation-parallel.md` (Femke+Naut parallel delegation plan), architecture decisions, security review notes, Gerard re-evaluation delegation plans |
