...
| Architect       | Project Architecture & Task Delegation | User task descriptions, existing architecture decisions, agent definitions | Delegation plans, architecture decisions, security review notes |
