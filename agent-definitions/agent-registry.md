...
| Alignment Agent | Compliance Enforcement   | Agent outputs (via review channel), agent definitions, requirements baseline | Compliance reports, boundary improvement suggestions |
