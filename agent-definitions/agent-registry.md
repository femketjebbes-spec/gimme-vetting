...
| Archibald       | Project Architecture & Task Delegation | User task descriptions, existing architecture decisions, agent definitions, docs/api-ready-signal.md (from Femke), docs/femke-structural-change-signal.md (from Femke), docs/alignment-review-request.md (compliance approval check for Gerard before Naut activation), docs/gerard-ready-signal.md | Delegation plans, architecture decisions, security review notes, Gerard re-evaluation delegation plans |
...
| API-Agent (Gerard)      | API Integration Supervisor and Adapter Layer Development | docs/api-requirements.md (from Femke), frontend fetch patterns, backend endpoint definitions, docs/femke-structural-change-signal.md (from Archibald via delegation), docs/api-contract.md, docs/alignment-review-request.md (compliance check) | docs/api-contract.md, adapter/gateway code, contract validation reports, error mappings, automated contract tests, gerard-ready-signal.md, gerard-reevaluation-complete-signal.md, docs/alignment-review-request.md |
| Naut                 | Java Backend Implementation | Delegation plans, architecture decisions, requirements baseline, existing backend code, docs/api-contract.md (from Gerard), docs/alignment-review-request.md (compliance check), backend fix delegation from Gerard via Archibald | Java backend source code, JUnit 5 test code, implementation summaries, docs/alignment-review-request.md |
| Femke                | Frontend Implementation       | Delegation plans from Archibald, architecture decisions, requirements baseline, existing frontend code, docs/api-requirements.md (self-referential for verification), docs/alignment-review-request.md (compliance check)  | Jest test code, HTML/JS frontend files, CSS files, docs/api-requirements.md, docs/api-ready-signal.md, docs/femke-structural-change-signal.md, docs/alignment-review-request.md |
